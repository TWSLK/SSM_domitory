...
<form id="formId1" class="form-horizontal" style="padding:30px 20px 10px 25px;">
	...
	<div class="form-group  mt-10">
  	...
  	<div class="form-group  mt-10">
    	<label class="col-xs-3 col-sm-3 col-md-3 control-label"   ><span style="color:#F00">*</span>评价</label>
    	<div class="col-xs-6 col-sm-6 col-md-6">
        	<input type="text" class="form-control" name="appraise" >
    	</div>
  	</div>
...
$(function(){
    ...
    $("#formId1").validate({
		rules:{
			...
			appraise:{required:true,minlength:1,maxlength:50},
		},
		onkeyup:false,
		focusCleanup:true,
