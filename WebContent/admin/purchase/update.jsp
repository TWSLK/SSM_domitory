...
<form id="formId1" class="form-horizontal" style="padding:30px 20px 10px 25px;">
	...
	<div class="form-group  mt-10">
    	<label class="col-xs-3 col-sm-3 col-md-3 control-label"   ><span style="color:#F00">*</span>采购名称</label>
    	<div class="col-xs-6 col-sm-6 col-md-6">
        	<input type="text" class="form-control" name="name" disabled>
    	</div>
  	</div>
  	  	<div class="form-group  mt-10">
    	<label class="col-xs-3 col-sm-3 col-md-3 control-label"   ><span style="color:#F00">*</span>商品名称</label>
    	<div class="col-xs-6 col-sm-6 col-md-6">
    		<input type="text" class="form-control" name="gname" disabled>
    	</div>
  	</div>
  	<div class="form-group  mt-10">
    	<label class="col-xs-3 col-sm-3 col-md-3 control-label"   ><span style="color:#F00">*</span>采购数量</label>
    	<div class="col-xs-6 col-sm-6 col-md-6">
        	<input type="text" class="form-control" name="qty" disabled>
    	</div>
  	</div>
  	<div class="form-group  mt-10">
    	<label class="col-xs-3 col-sm-3 col-md-3 control-label"   ><span style="color:#F00">*</span>实到入库数量</label>
    	<div class="col-xs-6 col-sm-6 col-md-6">
        	<input type="text" class="form-control" name="realqty" >
    	</div>
  	</div>
...
$(function(){
    ...
    $("#formId1").validate({
		rules:{
			...
			gid:{required:true,minlength:1,maxlength:10},
			qty:{required:true,minlength:1,maxlength:10},
			realqty:{required:true,minlength:1,maxlength:10},
		},
		onkeyup:false,
		focusCleanup:true,
