...
<form id="formId1" class="form-horizontal" style="padding:30px 20px 10px 25px;">
	...
	<div class="form-group  mt-10">
  	...
  	<div class="form-group  mt-10">
    	<label class="col-xs-3 col-sm-3 col-md-3 control-label"   ><span style="color:#F00">*</span>单价</label>
    	<div class="col-xs-6 col-sm-6 col-md-6">
        	<input type="text" class="form-control" name="price" disabled>
    	</div>
  	</div>
  	<div class="form-group  mt-10">
    	<label class="col-xs-3 col-sm-3 col-md-3 control-label"   ><span style="color:#F00">*</span>所属供应商</label>
    	<div class="col-xs-6 col-sm-6 col-md-6">
  	...
  	<div class="form-group  mt-10">
    	<label class="col-xs-3 col-sm-3 col-md-3 control-label"   ><span style="color:#F00">*</span>库存数量</label>
    	<div class="col-xs-6 col-sm-6 col-md-6">
...
$(function(){
	$.ajax({
        ...
        success:function(data){
       		...
       		$.getJSON("../goods/getInfo.do?"+ new Date().getTime(), {id:id}, function(data){
       			for(k in data){
       				if ($("[name='"+k+"']").length){
    ...
    $("#formId1").validate({
		rules:{
			...
			price:{required:true,minlength:1,maxlength:10},
			supplierid:{required:true,minlength:1,maxlength:10},
			stock:{required:true,minlength:1,maxlength:10},
		},
		onkeyup:false,
		focusCleanup:true,
