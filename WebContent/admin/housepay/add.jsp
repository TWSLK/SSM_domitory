...
<form id="formId1" class="form-horizontal" style="padding:30px 20px 10px 25px;">
	<input type="hidden" name="status" value="10" />
  	...
  	<div class="form-group">
    	<label for="fTable" class="col-xs-3 col-sm-3 col-md-3 control-label"><span style="color:#F00">*</span>缴费类型</label>
    	<div class="col-xs-6 col-sm-6 col-md-6">
       		<select class="form-control cmm_code" code="C017" name="paytype">
			</select>
    	</div>
  	</div>
  	<div class="form-group  mt-10">
    	<label class="col-xs-3 col-sm-3 col-md-3 control-label"   ><span style="color:#F00">*</span>缴费金额</label>
    	<div class="col-xs-6 col-sm-6 col-md-6">
...
$(function(){
    $("#formId1").validate({
		rules:{
			...
			paytype:{required:true,minlength:1,maxlength:50},
			amt:{required:true,minlength:1,maxlength:10},
		},
		onkeyup:false,
		focusCleanup:true,
